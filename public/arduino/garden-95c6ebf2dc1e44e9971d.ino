...
char ssid[] = "pesanDuaBelas";     // your network SSID (name)
char password[] = "pesanduabeslas"; // your network key
char raspi_input[] = "http://192.168.1.14:5000/input";
const char* control_page="control/2";
char id_arduino[]="95c6ebf2dc1e44e9971d";
char nama[]="Water Pump";
