...
char ssid[] = "24010316140118";     // your network SSID (name)
char password[] = "afkafkafk"; // your network key
char raspi_input[] = "http://192.168.1.15:5000/input";
const char* control_page="control/2";
char id_arduino[]="8c929c1fb57c4c388ef8";
char nama[]="Taman Indonesia";
